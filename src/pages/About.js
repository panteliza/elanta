  ...
  return (
    <div>
      ...
      <div className="flex flex-col  my-7 ">
        <div className='ml-5'>
          <h1 className="text-3xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-purple-500 via-red-600 to-purple-700">
      ...
      <div className="w-full">
        <img src={diapers} className="h-[640px] w-full object-cover" alt="Slider" />
          ...
          <div className="w-1/2  px-10 text-justify">
            <p className='text-[16px]'>About Elanta Health Care And Hygiene Products Pvt. Ltd
